...
public:
  void func3()
  {
    ...
    //pri;//error: ‘int Parent::pri’ is private within this context
  }
};
...
public:
  void sub_fun3()
  {
    // pub; //error: ‘int Parent::pub’ is inaccessible within this context
    // pro; //error: ‘int Parent::pro’ is protected within this context
  }
};
